-- Race Results Repository - RML document type + model namespace metadata (MariaDB)
-- Version 2.0.0
...
-- RML is client-produced and client-consumed (the timer client), and also
-- manageable by regatta admins; viewers may read.
